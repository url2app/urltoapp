...
describe('checkVersion', () => {
    ...
    test('should skip check when version_check is disabled and forceCheck is false', async () => {
    ...
    test('should perform check and detect update if latest version is higher', async () => {
    ...
    test('should detect no update if versions are equal', async () => {
        getSetting.mockReturnValue(true);
    ...
    test('should return error object on request failure', async () => {
        getSetting.mockReturnValue(true);
