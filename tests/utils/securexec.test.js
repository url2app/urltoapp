...
describe('secureExec', () => {
  ...
  it('should call sanitizeCommand with the original command', () => {
    sanitizeCommand.mockReturnValue('safe_cmd');
    child_process.execSync.mockReturnValue(Buffer.from('result'));
  ...
  it('should call execSync with the sanitized command', () => {
  ...
  it('should return the result of execSync', () => {
  ...
  it('should pass options to execSync if provided', () => {
